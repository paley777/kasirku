        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ $active === 'data' ? 'active' : '' }}" href="#" id="navbarDropdown" role="button"
                  ...
                  <li class="nav-item">
                    <a class="nav-link {{ $active === 'cashier' ? 'active' : '' }}" href="/dashboard/cashier">Sistem Kasir</a>
                </li>
                  <li class="nav-item">
                    <a class="nav-link {{ $active === 'rekap' ? 'active' : '' }}" href="/dashboard/rekapitulasi">Rekapitulasi</a>
                </li>
